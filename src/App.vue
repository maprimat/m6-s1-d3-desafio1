        ...
        <div id="app">
            <div class="contenedorForm">
                <form v-on:submit.prevent="emitirCi">
                    <div>
                        <p>Ingrese RUN con punto y guión incluidos</p>
                    </div>
                    <div class="inputrut">
                        <label for="run">Run: </label>
                        <input type="text" name="run" id="run" v-model="run" maxlength="12" />
                    </div>
            ...
            <div class="carnet">
                <aside>
                    ...
                    <img src="./assets/img/foto_elon.jpg" alt="elon mask" />
                    <p>RUN {{ run }}</p>
                </aside>
...
export default {
    ...
    methods: {
        emitirCi: function () {
            alert(`Cliente con run ${this.run} registrado éxitosamente.`);
        },
